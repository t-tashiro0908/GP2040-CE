...
void GP2040::run() {
	...
	while (1) { // LOOP
		...
		// ボタンを押す時間
		constexpr uint32_t PRESS_MS = 100;
		
		// 起動時操作が終わった後、周回を開始する時刻
		constexpr uint32_t MACRO_START_MS = 10000;
